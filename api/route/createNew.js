            ...
            connection.query('SELECT * FROM admin WHERE Name = "' + req.body.Name + '" AND ( City = "' + req.body.City + '" OR Pincode = "' + req.body.Pincode + '")', function(err, result1) {
              if (err) {
                ...
                if (result1 != '') {
                  ...
                  connection.query('INSERT INTO admin (Name,Email,Mobile,Address,City,Pincode,Date) VALUES ("' + req.body.Name + '","' + req.body.Email + '","' + req.body.Mobile + '","' + req.body.Address + '","' + req.body.City + '","' + req.body.Pincode + '","' + date + '"); INSERT INTO login(Role,User,Pass,Name,Date,Email) VALUES( "Admin","' + req.body.Mobile + '", "12345", "' + req.body.Name + '","' + date + '", "' + req.body.Email + '")', function(err, result2) {
                    if (err) {
                      return next(err);
                    } else {
            ...
            connection.query('SELECT * FROM company WHERE Name = "' + req.body.Name + '" AND ( City = "' + req.body.City + '" OR Pincode = "' + req.body.Pincode + '")', function(err, result1) {
              if (err) {
                ...
                if (result1 != '') {
                  ...
                  var sql = 'INSERT INTO company(Name,Registration,Landline,Email,Website,YOI,Address,City,State,Pincode,District,HR_Name,HR_Email,HR_Mobile,Logo,Date) VALUES ("' + req.body.Name + '","' + req.body.Registration + '","' + req.body.Landline + '","' + req.body.Email + '","' + req.body.Website + '","' + req.body.YOI + '","' + req.body.Address + '","' + req.body.City + '","' + req.body.State + '","' + req.body.Pincode + '","' + req.body.District + '","' + req.body.HR_Name + '","' + req.body.HR_Email + '","' + req.body.HR_Mobile + '","' + req.body.Logo + '","' + date + '");INSERT INTO login(Role,User,Pass,Name,Date,Email) VALUES( "Company","' + req.body.HR_Mobile + '", "12345", "' + req.body.Name + '", "' + date + '", "' + req.body.HR_Email + '")';
                ...
                if (result1 != '') {
                  ...
                  connection.query('INSERT INTO college(Name,Registration,Landline,Email,Mobile,Type,Address,City,State,Pincode,District,TPO_Name,TPO_Email,TPO_Mobile,Logo,Date) VALUES ("' + req.body.Name + '","' + req.body.Registration + '","' + req.body.Landline + '","' + req.body.Email + '","' + req.body.Mobile + '","' + req.body.Type + '","' + req.body.Address + '","' + req.body.City + '","' + req.body.State + '","' + req.body.Pincode + '","' + req.body.District + '","' + req.body.TPO_Name + '","' + req.body.TPO_Email + '","' + req.body.TPO_Mobile + '","' + req.body.Logo + '","' + date + '")', function(err, result2) {
                    if (err) {
                      ...
                      console.log("result2");
                      connection.query('INSERT INTO login(Role,User,Pass,Name,Date,Email) VALUES( "College","' + req.body.TPO_Mobile + '", "12345", "' + req.body.Name + '","' + date + '","' + req.body.TPO_Email + '")', function(err, result3) {
                        if (err) {
                          return next(err);
                        } else {
                          console.log("result3");
